...
compile(File, OutIncludeDir, OutSrcDir)->
    protobuffs_compile:generate_source(File,
        [{output_include_dir, OutIncludeDir}, {output_src_dir, OutSrcDir}]),
    ok.

check(AppName, SrcPath, DstPath)->
    ...
    EnumData = lists:append([
        ...
        "package Platform.", AppName, ".Proto;\n",
        "\nenum E_MESSAGE_TYPE\n",
        "{\n",
