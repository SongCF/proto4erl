...
run(RootPath0)->
    RootPath = case lists:last(RootPath0) of
                   $/ -> RootPath0;
                   _ -> RootPath0 ++ "/"
               end,
    Src = RootPath ++ "payload.proto",
    ...
    CmdNameFile = RootPath ++ "packet_x.erl",
